...
if(isset($_SESSION['etape1']) && isset($_POST['code']) && isset($_POST['verifyCode'])){
if($_POST['code'] == $_COOKIE['verification_code']){
  ...
  header('Location: ../views/admin/connexion/newPassAdmin.php');
}
//si le code saisie est incorrecte
  ...
  header('Location: ' . $_SERVER['HTTP_REFERER']);
    ...
    header('Location: ../views/resetPassAdmin.php');
}
?>