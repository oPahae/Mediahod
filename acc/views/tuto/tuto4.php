...
<div class="content-page">
    <div class="container-fluid">
        ...
        <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h1 class="titleposst text-center mb-5" style="color: #407cfd;">How to unlock Facebook account with email verification code (code 956)</h1>
                        
                        <p>- Please see and follow the image instructions below:</p>

<p><img alt="" src="../assets/tuto/tuto4-1.jpeg" style="border-radius:30px; border:1px solid #a5a5a5; height:100%; width:100%"></p>

<p><img alt="" src="../assets/tuto/tuto4-2.jpeg" style="border-radius:30px; border:1px solid #a5a5a5; height:100%; width:100%"></p>

<p><img alt="" src="../assets/tuto/tuto4-3.jpeg" style="border-radius:30px; border:1px solid #a5a5a5; height:100%; width:100%"></p>

<p><img alt="" src="../assets/tuto/tuto4-4.jpeg" style="border-radius:30px; border:1px solid #a5a5a5; height:100%; width:100%"></p>

<hr>
<p>- Open a new browser Tab and go to this link to log in to your hotmail account: <a href="https://login.live.com/login.srf">https://login.live.com/login.srf</a>
<img alt="" src="../assets/tuto/tuto4-5.jpeg" style="border-radius:30px; border:1px solid #a5a5a5; height:100%; width:100%"></p>

<p><img alt="" src="../assets/tuto/tuto4-6.jpeg" style="border-radius:30px; border:1px solid #a5a5a5; height:100%; width:100%"></p>

<hr>
<p>- Return to the Facebook Login Tab and enter the verification code from Hotmail into the blank box.</p>

<p><img alt="" src="../assets/tuto/tuto4-7.jpeg" style="border-radius:30px; border:1px solid #a5a5a5; height:100%; width:100%"></p>

<p><img alt="" src="../assets/tuto/tuto4-8.jpeg" style="border-radius:30px; border:1px solid #a5a5a5; height:100%; width:100%"></p>

<p>Continue with the next steps to unlock your Facebook account. Goodluck!</p>
                                            </div>
                </div>
            </div>
            <div class="col-sm-4">
