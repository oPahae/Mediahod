...
elseif(!isset($_SESSION['etape1']) || !isset($_SESSION['email'])){
...
<body>
    <div class="container">
        <h1>Verification</h1>
        <form class="verificationForm" action="../../controllers/verifyCode.php" method="post">
            ...
            <a href="../../controllers/resendCode.php" style="color: #fff; font-weight: bold;">Code Not Sent ? Send Again</a>
        </form>
