...
if(isset($_SESSION['isConnected'])){
    $_SESSION['MessageE'] = "You Are Alread Loginin" ;
...
<body>
    <div class="container">
        ...
        <form class="emailForm" action="../../controllers/sendCode.php" method="post">
            <div class="input-container">
                <input type="email" id="email" name="email" required placeholder="" />
                <label for="email">Email</label>
            </div>
            <button type="submit" class="submit-btn" name="sendMail">Submit</button>
        </form>
