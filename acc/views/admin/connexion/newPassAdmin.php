...
<body>
    <div class="container">
        <h1>New Password</h1>
        <form class="verificationForm" action="../../../controllers/updatePasswordAdmin.php" method="post">
            <div class="input-container">
                <input type="text" id="verification-code" name="newLogin" required placeholder="" />
                <label for="verification-code">New Login</label>
            </div>
            <div class="input-container">
                <input type="password" id="verification-code" name="newPassword" required placeholder="" />
