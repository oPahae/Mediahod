...
<body>
    <div class="container">
        ...
        <form class="verificationForm" action="../../../controllers/verifyCodeAdmin.php" method="post">
            <div class="input-container">
                <input type="number" id="verification-code" name="code" required placeholder=" " />
                <label for="verification-code">Verification Code</label>
            </div>
            <button type="submit" class="submit-btn" name="verifyCode">Submit</button>
            <a href="../../../controllers/resendCodeAdmin.php" style="color: #fff; font-weight: bold;">Code Not Sent ? Send Again</a>
        </form>
        ...
        <div class="hidden-message sent" id="sent-message">
            Code sent !
        </div>
    </div>
