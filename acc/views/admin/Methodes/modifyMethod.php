...
elseif(isset($_GET['id'])){
    ...
    $met = new Methodes();
    $methodes = $met->getMethodById($_GET['id']);
}
else{
...
<body>
        ...
        <!-- page -->
         <div class="page">
            ...
            <div class="modifyPay">
                ...
                <h1>Modify Payment Info</h1>
                <form id="payment-form" action="../../../controllers/methodesController.php" method="post">
                    <input type="number" name="id" value="<?php echo $methodes['ID'] ?>" hidden>
                    <label for="network">Network</label>
                    <input type="text" id="network" name="network" value="<?php echo $methodes['Network'] ?>" disabled>
    
                    <label for="address">Address</label>
                    <input type="text" id="address" name="address" value="<?php echo $methodes['adresse'] ?>" disabled>
    
                    <label for="note">Note</label>
                    <input type="text" id="note" name="note" value="<?php echo $methodes['Note'] ?>" disabled>
    
                    <div class="button-group">
                        <button type="button" id="edit-button">Edit</button>
                        <button type="submit" id="save-button" disabled name="action" value="modify">Save</button>
                    </div>
                </form>
                <!-- <div id="success-message">Payment Modified Successfuly !</div> -->
            </div>
         </div>
    </div>
    ...
    <script>
        ...
        const formElements = document.querySelectorAll('#payment-form input, #payment-form textarea, #payment-form select')
