<?php
// Récupérer les utilisateurs bannis depuis le fichier JSON
$banned_users_file = '../../security/banned_users.json';
                    ...
                    <tbody>
                        <?php if (!empty($banned_users)) : ?>
                            <?php foreach ($banned_users as $user) : ?>
                                <tr>
                                    <td data-title='IP'><?= htmlspecialchars($user['ip']) ?></td>
                                    <td data-title='Date'><?= htmlspecialchars($user['ban_time']) ?></td>
                                    <td data-title='Location'><?= htmlspecialchars($user['location']) ?></td>
                                    <td data-title='Region'><?= htmlspecialchars($user['region']) ?></td>
                                    <td data-title='Country'><?= htmlspecialchars($user['country']) ?></td>
                                    <td data-title='FAI'><?= htmlspecialchars($user['isp']) ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
                            <tr>
                                <td colspan="6" style="text-align: center;">Aucun utilisateur banni pour le moment.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
