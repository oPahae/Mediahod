...
elseif(!isset($_GET['idSub'])){
    ...
    $pro = new Produit();
    $allprod = $pro->getProdBySousCat($_GET['idSub']);
}
         ...
         <div class="page">
            ...
            <div class="product">
                ...
                <table>
                    ...
                    <tbody>
                        <?php foreach($allprod as $x ) : ?>
                            <?php if($x['disponibilite'] == 1) : ?>
                        <tr>
                            <td data-title='ID'><?php echo $x['id'] ?></td>
                            <td data-title='Label'><?php echo $x['libelle'] ?></td>
                            <td data-title='Price'><?php echo $x['prix'] ?></td>
                            <td data-title='Stock'><?php echo $x['stock'] ?></td>
                            <td data-title='Modify'><a href="modifyProd.php?idProd=<?php echo $x['id'] ?>" style="color: yellow"><i class="fa-solid fa-marker"></i></a></td>
                            <td data-title='Delete'>
    <a style="color: orange;" href="../../../controllers/produitController.php?action=deletePro&id=<?php echo $x['id'] ?>"
