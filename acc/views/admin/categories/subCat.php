...
elseif(!isset($_GET['idCat'])){
    ...
    $allsub = $subcat->getSousCategoriesByCategorieId($_GET['idCat']);
}
         ...
         <div class="page">
            ...
            <div class="subCat">
                ...
                <table>
                    ...
                    <tbody>
                        <?php foreach($allsub as $x) : ?>
                        <tr>
                            <td data-title='ID'><?php echo $x['id'] ?></td>
                            <td data-title='Name'><?php echo $x['nom'] ?></td>
                            <td data-title='Modify'><a href="modifySubCat.php?idSub=<?php echo $x['id'] ?>" style="color: yellow"><i class="fa-solid fa-marker"></i></a></td>
                            <td data-title='Delete'> <a onclick="return confirmDelete();" style="color: orange;" href="../../../controllers/sousCategoriesController.php?action=deleteSub&id=<?php echo $x['id']?>"><i class="fa-solid fa-trash"></i></a></td>
                            <td data-title='Details'><a href="product.php?idSub=<?php echo $x['id'] ?>" style="color: chartreuse;"><i class="fa-solid fa-eye"></i></a></td>
                        </tr>
                            <?php endforeach; ?>
                    </tbody>
                </table>
