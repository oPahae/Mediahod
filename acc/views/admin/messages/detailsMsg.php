...
if(!isset($_GET['id'])){
    ...
    $mes = new Message();
    $messages = $mes->getMessageById($_GET['id']);
}
            ...
            <div class="detailsMsg">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <!-- <img style="width: 100%;" src="../../assets/tutorialTest.png" alt=""> -->
                                 <?php if($messages['image'] != null):?>
                                    <a href="<?php echo $messages['image'] ?>" target="_blank">
                                <img style="width: 100%;" src="<?php echo $messages['image'] ?>" alt="">
                                </a>
                                <?php //else : ?>
                                    <!-- Aucun Piece Jointe -->
                                    <?php endif; ?>
