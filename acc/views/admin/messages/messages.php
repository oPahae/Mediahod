            ...
            <div class="messages">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td data-title='Username(ID)'><?php echo $x['username'] ?></td>
                            <td data-title='Date'><?php echo $x['dateEnv'] ?></td>
                            <td data-title='Email'><?php echo $x['email'] ?></td>
                            <td data-title='Whatsapp'><?php echo $x['whatsapp'] ?></td>
                            <td data-title='Delete'><a onclick="return confirmDelete();" style="color: orange;" href="../../../controllers/messageController.php?action=deleteMessage&id=<?php echo $x['id'] ?>"><i class="fa-solid fa-trash"></i></a></td>
                            <td data-title='Details'><a href="detailsMsg.php?id=<?php echo $x['id'] ?>" style="color: chartreuse;"><i class="fa-solid fa-eye"></i></a></td>
                        </tr>
                            <?php endforeach;  ?>
                    </tbody>
                </table>
