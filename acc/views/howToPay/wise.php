...
<div class="row justify-content-around"> 
    <div class="col-6 col-md-3">
        <a href="howToPay.php" class="btn btn-outline-primary w-100 d-flex justify-content-center">
            <img src="../assets/bankTransfer.svg" width="25" class="me-2">
            <span data-key="dp-tien-ma-hoa">Bank Transfer</span>
        </a>
    </div>
    <div class="col-6 col-md-3">
        <a href="wise.php" class="btn btn-primary w-100 d-flex justify-content-center">
            ...
            <div class="row">
                <div class="col-md-12">
                <h1 style="font-size: 23px;">Wise Transfer, Revolut</h1>
            </div>
         <div class="col-lg-6">
             <div class="card">
                <div class="list-group-item" role="alert">
                        <i class="ri-alert-line"></i>
                    <div class="iq-alert-text"><p><strong>TOP UP VIA WISE OR REVOLUT</strong>
                    </p><p><strong>Please follow the instructions exactly. (Can use Revolut )</strong></p>
<?php if($bonus != null) : ?>
    <p><span style="color:#006600"><strong><?php echo $bonus ?></strong></span></p>
    <?php endif; ?>

<p><strong><span style="color:#ff0000">Min transfer 115,000VND,&nbsp;</span><span style="color:#ff0000">(Does not include transfer fees)</span> Low bills we will not process.!-&nbsp;The transaction fee is quite high, you can choose other ways to <a href="howToPay.php">transfer money here</a>.</strong></p>

<p><strong>STEP-BY-STEP VIDEO INSTRUCTIONS:&nbsp;<a href="https://vimeo.com/891021166" target="_blank">https://vimeo.com/891021166</a></strong></p>

<p>- <strong>Step 1</strong>: Sign in to your Wise account. Go to the "<strong>Recipients</strong>" page.</p>

<p>- <strong>Step 2</strong>: Click "&nbsp;<strong>Add</strong>&nbsp;", Click " <strong>Someone else</strong> ". Then&nbsp;select currency <strong><?php echo $wise['currency'] ?>.&nbsp;</strong>Use the information below.</p>

<p>-&nbsp;<strong>Step 3</strong>:&nbsp;Enter the information: [ Information below. ]</p>

<ul>
	<li><strong>Their Email</strong>:&nbsp;<strong><?php echo $wise['email'] ?></strong></li>
	<li><strong>Full Holder Name</strong>:&nbsp;<strong><?php echo $wise['holder_name'] ?></strong></li>
	<li><strong>Bank Name:&nbsp;&nbsp;<?php echo $wise['bank_name'] ?></strong></li>
	<li><strong>Bank Code (BIC/SWIFT)</strong>:&nbsp;<strong><?php echo $wise['bank_code'] ?></strong></li>
	<li><strong>Account Number</strong>:&nbsp;<strong><?php echo $wise['account_number'] ?></strong></li>
	<li><strong>Address</strong>:&nbsp;<strong><?php echo $wise['address'] ?></strong></li>
	<li><strong>City</strong>:&nbsp;<strong><?php echo $wise['city'] ?></strong></li>
	<li><strong>Zipcode</strong>:&nbsp;<strong><?php echo $wise['zipcode'] ?></strong></li>
</ul>

<p>-&nbsp;<strong>Step 4</strong>:&nbsp;Click "<strong>Confirm</strong>". Then&nbsp;return to "Recipients" page. Click " <strong>Send</strong> "&nbsp;Continue with the next steps.</p>

<p>**After successful deposit, please send screenshot to <a href="https://t.me/accmoonsp">Support Accmoon</a></p>
</div>
                </div>
                    </div>
                    </div>
        <div class="col-lg-6">
         <ul class="list-group mb-2">
            <li class="list-group-item">Currency: <b><?php echo $wise['currency'] ?></b></li>
            <li class="list-group-item">Their Email: <b id="copyemail"><?php echo $wise['email'] ?></b>
            <button onclick="copy()" data-clipboard-target="#copyemail" class="copy btn btn-primary btn-sm"><i class="fas fa-copy"></i></button></li>
            
            <li class="list-group-item">Full Holder Name: <b id="copyname"><?php echo $wise['holder_name'] ?></b>
            <button onclick="copy()" data-clipboard-target="#copyname" class="copy btn btn-primary btn-sm"><i class="fas fa-copy"></i></button></li>
            
            <li class="list-group-item">Bank Name: <b id="bankcode2"><?php echo $wise['bank_name'] ?></b>        
            <button onclick="copy()" data-clipboard-target="#bankcode2" class="copy btn btn-primary btn-sm"><i class="fas fa-copy"></i></button></li>
            <li class="list-group-item">Bank Code (BIC/SWIFT): <b id="bankcode3"><?php echo $wise['bank_code'] ?></b>        
            <button onclick="copy()" data-clipboard-target="#bankcode3" class="copy btn btn-primary btn-sm"><i class="fas fa-copy"></i></button></li>
                                           
            <li class="list-group-item">Account Number: <b id="banknumber2"><?php echo $wise['account_number'] ?></b>
            <button onclick="copy()" data-clipboard-target="#banknumber2" class="copy btn btn-primary btn-sm"><i class="fas fa-copy"></i></button></li>
            
            <li class="list-group-item">Address: <b id="address"><?php echo $wise['address'] ?></b>
            <button onclick="copy()" data-clipboard-target="#address" class="copy btn btn-primary btn-sm"><i class="fas fa-copy"></i></button></li>
            <li class="list-group-item">City: <b id="city"><?php echo $wise['city'] ?></b>
            <button onclick="copy()" data-clipboard-target="#city" class="copy btn btn-primary btn-sm"><i class="fas fa-copy"></i></button></li>
            <li class="list-group-item">Zipcode: <b id="zipcode"><?php echo $wise['zipcode'] ?></b>
            <button onclick="copy()" data-clipboard-target="#zipcode" class="copy btn btn-primary btn-sm"><i class="fas fa-copy"></i></button></li>
               
            </ul><br>
             <center><i><i class="fa fa-share" aria-hidden="true"></i> Please send the transaction screenshot to the <a href="https://t.me/accmoonsp">Support Accmoon</a></i></center><br>
        </div>
