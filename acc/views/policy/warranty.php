...
<head>
    ...
    <title> Warranty and Return Policy</title>
...
<div class="content-page">
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h1 class="text-center">Warranty and Return Policy</h1>
                        <h3><strong>WARRANTY ACCEPTED - FACEBOOK ACCOUNTS</strong></h3>

<p>Within 24 hours from the time the facebook account is purchased on the system, the customer is entitled to the warranty in the following cases:<br>
1. First time login failed (Wrong UID, wrong password, wrong 2FA code)<br>
2. Account with pre-restricted ads (Cannot create Camp, Add BM)<br>
3. Account has been disabled personal ad account before</p>

<p><strong>WARRANTY DISCLAIMER - FACEBOOK ACCOUNTS</strong></p>

<p>Customers are not warranted for their facebook account in the following cases:<br>
1. Your account is checkpointed by creating Camp, Add card, Add BM, Add personal facebook account, register BM...<br>
2. Your account is restricted from advertising by creating Camp, Add card, Add BM, Add personal facebook account, register BM...<br>
3. Your account has been disabled by you for personal advertising accounts by creating Camp, Add cards<br>
4. Account is checkpointed after logging in or changing account information<br>
5. Account threshold is reduced after adding card or changing time zone, currency</p>

<hr>
<p><strong>WARRANTY ACCEPTED - BUSINESS MANAGER</strong></p>

<p>Within 24 hours since Link BM is purchased on the system, customers have the right to be warranted in the following cases:<br>
1. Invite Link to receive BM cannot be accessed (Link error, Link expired)<br>
2. BM is restricted from advertising (BM die - Unable to create ad account)<br>
3. BM has ad account disabled (BM live - Die ad account)<br>
(*) For Business Verification BM: Warranty 1 to 1 if the green is missing within 3 days from the date of purchase of the BM on the system (This term is accepted if the BM is not violated the terms party item disclaimer of warranty)</p>

<p><strong>WARRANTY DISCLAIMER - BUSINESS MANAGER</strong></p>

<p>1. BM that you created Camp (Including draft)<br>
2. BM has been added payment information by you (Add card)<br>
3. BM has been created an ad account by you<br>
5. BM has been created Pixel by you or received Pixel from another BM<br>
6. BM verified by temporary mail service (Mail10m,...)<br>
7. BM's threshold dropped<br>
8. Change ad account currency in BM<br>
9.&nbsp;For Business Verification BM, we only support 3 days warranty. If after this time lost, we do not support the warranty. This is very normal. The cause is that your product or service violates the policy or is suspicious in the payment and use of untrusted ip.<br>
(*) Within 24 hours of soaking BM: If BM is restricted from advertising or the Ad Account is disabled, absolutely do not arbitrarily resist BM (Ad account). If you have pressed resistance then that BM will not be covered under warranty.</p>

<hr>
<p><strong>WARRANTY ACCEPTED - GOOGLE ADS ACCOUNT</strong></p>

<p>1. The account has not changed security information.<br>
1.&nbsp; Account has not been deactivated</p>

<p><strong>WARRANTY DISCLAIMER - GOOGLE ADS ACCOUNT</strong></p>

<p>1. Account is disabled after creating a campaign or after adding a payment card.<br>
2.&nbsp;The account has changed its security information.</p>

<hr>
<p><strong>WARRANTY POLICY FOR GMAIL ACCOUNT</strong></p>

<p>We support replacement when the login account is faulty, 1 week warranty</p>
                    </div>
                </div>
            </div>
        </div>
